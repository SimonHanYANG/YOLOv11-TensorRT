'''
python val-video-tensorrt.py --video input_video.mp4 --output results/output_video.mp4 --conf 0.25 --preview

python val-video-tensorrt.py --video ~/UNeXt-pytorch/inputs/Sperm_Selection_Video_Test/20241105_121237814.mp4 --output video_tensorrt_results/20241105_121237814.mp4 --conf 0.25

python val-video-tensorrt.py --video ~/UNeXt-pytorch/inputs/Sperm_Selection_Video_Test/20241105_121237814.mp4 --output video_tensorrt_results/20241105_121237814.mp4 --conf 0.25 --preview
'''
...
def process_video(engine, video_path, output_path, class_names, conf_threshold=0.25, iou_threshold=0.45, show_preview=False):
    """处理视频文件"""
    # 打开视频文件
    ...
    while True:
        ...
        # 绘制检测结果
        result_frame = draw_boxes(frame, boxes, scores, class_ids, class_names)
        ...
        if show_preview:
            ...
            cv2.imshow('YOLOv8 TensorRT Detection', preview_frame)
...
def main():
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='YOLOv8 TensorRT 视频处理')
    parser.add_argument('--engine', type=str, default="runs/train/weights/best.engine", help='TensorRT引擎文件路径')
