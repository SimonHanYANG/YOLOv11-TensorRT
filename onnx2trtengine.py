"""
# 基本用法 python onnx2trtengine.py --onnx runs/train/weights/best.onnx --engine runs/train/weights/spermYolov11n.engine.

python onnx2trtengine.py --onnx yolov8n.onnx --engine yolov8n.engine

# 使用FP16精度 python onnx2trtengine.py --onnx yolov8n.onnx --engine yolov8n.engine --fp16

# 自定义输入尺寸 python onnx2trtengine.py --onnx yolov8n.onnx --engine yolov8n.engine --height 1280 --width 1280
"""
